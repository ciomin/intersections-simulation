...
public class Controller2 {
    public static void main (String []args) {
        ...
        T6Ct11.SetNextCondition(LogicConnector.AND, T6Ct3);
        ...
        Condition T8Ct3 = new Condition(t8, "in4", TransitionCondition.NotNull);
        T8Ct1.SetNextCondition(LogicConnector.AND, T8Ct2);
        T8Ct11.SetNextCondition(LogicConnector.AND, T8Ct3);
